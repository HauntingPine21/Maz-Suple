...
<header>
    <div class="navbar dashboard-navbar"> 
...
<div class="main-container">
        ...
        <div class="welcome-banner">
            ...
            <p>Bienvenido al sistema de gestión MazSuple.</p>
        </div>
        ...
        <?php if ($rol === 'admin'): ?>
            ...
            <div class="card admin-panel-container">
                <div class="admin-header">
                    ...
                    <p>Zona restringida para control del negocio.</p>
                </div>
                ...
                <div class="admin-grid-actions">
                    ...
                    <a href="productos.php" class="admin-btn-card">
                        <svg viewBox="0 0 24 24">
                            <path d="M18 2H6c-1.1 0-2 .9-2 
                                2v16c0 1.1.9 2 2 
                                2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM6 
                                4h5v8l-2.5-1.5L6 12V4z"/>
                        </svg>
                    ...
                    <a href="compras.php" class="admin-btn-card">
                        <svg viewBox="0 0 24 24">
                            <path d="M7 18c-1.1 0-1.99.9-1.99 
                                ...
                                0 1.41-.41 1.75-1.03l3.58-6.49A1.003 1.003 
                                0 0 0 20 4H5.21l-.94-2H1zm16 
                    ...
                    <a href="reportes/ventas_encabezado.php" class="admin-btn-card">
                        <svg viewBox="0 0 24 24">
                            <path d="M3.5 18.49l6-6.01 4 
                                4L22 6.92l-1.41-1.41-7.09 
                                7.97-4-4L2 16.99z"/>
                        </svg>
